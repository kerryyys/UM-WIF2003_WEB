    ...
    <div className="App">
      <header className="App-header">
        <div className="cardSuccessful">
          ...
          <br></br>
          <br></br>
          <button onClick={() => window.location.href = '/invoiceList'} className='buttonSuccessful'>Generate Invoice</button>
          <br></br>
          <button onClick={() => window.location.href = '/paymentHis'} className='buttonSuccessful'>View Payment History</button>
        </div>
      </header>
    </div>
  );
