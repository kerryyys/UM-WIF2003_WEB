...
<div onClick={() => window.location.href = '/invoice'} className="INV">
  <p className='INVName'>Completed</p>
  <p className='INVPrice'>Input data from scanned documents into Excel spreadsheet format</p>
...
<div onClick={() => window.location.href = '/invoice'} className="INV">
  <p className='INVName'>Completed</p>
  <p className='INVPrice'>Write 10 blog articles on topics related to digital marketing and SEO</p>
