...
function EnterCode() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!password || !newPassword) {
            setErrorMessages({ name: 'password', message: 'Please enter both password and new password' });
        } else {
    ...
    return (
        <div className="background">
            ...
            <form onSubmit={handleSubmit} className="forgot-container">
                ...
                {showNotification && <Notification message="Password Reset Successfully!" />} {/* Conditionally render the notification */}
